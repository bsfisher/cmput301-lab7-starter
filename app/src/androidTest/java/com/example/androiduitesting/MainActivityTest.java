...
public class MainActivityTest {
    ...
    public void testActivitySwitch(){
        ...
        // Verify view has been swapped
        onView(withId(R.id.backShowButton)).check(matches(isDisplayed()));
    }
    @Test
    public void testShowActivityDisplaysName(){
        // Add first city to the list
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
    ...
    public void testShowActivityBack(){
        ...
        onData(anything()).inAdapterView(withId(R.id.city_list))
                .atPosition(0).perform(click());
        // Verify back button takes to main activity
        onView(withId(R.id.backShowButton)).perform(click());
